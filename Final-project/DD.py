...
c=conn.cursor()
print(conn)
from tkinter import LabelFrame, Label,END, Tk,StringVar,LEFT,Entry,OptionMenu,W,Button,Text
import numpy as np
import pandas as pd
...
def Bagging():
    ...
    if (h=='yes'):
        t51.delete("1.0", END)
        t51.insert(END, disease[a])
    else:
        t51.delete("1.0", END)
        t51.insert(END, "Not Found")
...
def drugPred():
    ...
    if(logitdisease == "Diabetes" or svcdisease == "Diabetes"):
        ...
        z=c.execute("select drugName from Medicine where condition=?;",([svcdisease]))
        y=c.fetchmany(1)
        print(y)
        if(y==[]):
            t6.insert(END,"No medicine for recommendation")
        else:
            t6.insert(END,y)
...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Prediction using Machine Learning", fg="blue", bg="cyan")
w2.config(font=("Elephant", 40))
...
S1Lb = Label(root, text="Symptom 1", fg="red", bg="white")
S1Lb.grid(row=7, column=0, pady=10, sticky=W)

S2Lb = Label(root, text="Symptom 2", fg="red", bg="white")
S2Lb.grid(row=8, column=0, pady=10, sticky=W)

S3Lb = Label(root, text="Symptom 3", fg="red", bg="white")
S3Lb.grid(row=9, column=0, pady=10, sticky=W)

S4Lb = Label(root, text="Symptom 4", fg="red", bg="white")
S4Lb.grid(row=10, column=0, pady=10, sticky=W)

S5Lb = Label(root, text="Symptom 5", fg="red", bg="white")
...
#BaggingLb = Label(root, text="BaggingClassifier", fg="white", bg="red")
#BaggingLb.grid(row=18, column=0, pady=10, sticky=W)

log = Label(root, text="LogisticRegression", fg="red", bg="white")
log.grid(row=15, column=0, pady=10, sticky=W)

svc = Label(root, text="SupportVectorMachine", fg="red", bg="white")
svc.grid(row=16, column=0, pady=10, sticky=W)

bc = Label(root, text="BaggingClassifier", fg="red", bg="white")
bc.grid(row=17, column=0, pady=10, sticky=W)

dp = Label(root, text="Drug Prediction", fg="red", bg="white")
dp.grid(row=18, column=0, pady=10, sticky=W)
...
logit = Button(root, text="LogisticRegression", command=LogisticRegression,bg="green",fg="yellow")
logit.grid(row=8, column=3,padx=10)

svm = Button(root, text="SupportVectorMachine", command=SVC,bg="green",fg="yellow")
svm.grid(row=9, column=3,padx=10)

bce = Button(root, text="BaggingClassifier", command=Bagging,bg="green",fg="yellow")
bce.grid(row=10, column=3,padx=10)


dpt = Button(root, text="Drug Prediction", command=drugPred,bg="green",fg="yellow")
dpt.grid(row=11, column=3,padx=10)
...
t51 = Text(root, height=1, width=40,bg="white",fg="black")
t51.grid(row=17, column=1 , padx=10)

t6 = Text(root, height=2, width=40,bg="white",fg="black")
t6.grid(row=18, column=1 , padx=10)
